    ...
    return AmazingOverlay<OneAnimation>(
      ...
      onDialogOpened: (TickerProvider vsync) {
        ...
        Animation<double> animation = CurvedAnimation(
            ...
            .drive(Tween<double>(begin: 60.0, end: 0.0));
      ...
      child: Column(
        ...
        children: [
          AnimatedBuilder(
              ...
              builder: (context, _) {
                return Opacity(
                  opacity: animations.animationController.value,
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          boxShadow ??
                              BoxShadow(
                                  color: (theme.dialogTheme.shadowColor ??
                                          Colors.transparent)
                                      .withOpacity(.2),
                            ...
                            children: [
                              Row(
                                children: [
                                  Transform.translate(
                                    offset: Offset(
                                        0, (animations.animation.value
                                    as double) * animations.animationController.velocity.abs()),
                                    child: Text(
                                      titleText,
